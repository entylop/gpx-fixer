...
public class Field {
    ...
    public Field(String name, int num, int type, double scale, double offset, String units, boolean accumulated) {
    ...
    public void setValue(int fieldArrayIndex, Object value, int subFieldIndex) {
        ...
        if (subFieldIndex != Fit.SUBFIELD_INDEX_MAIN_FIELD) {
            ...
            if (subField == null)
                throw new FitRuntimeException("com.garmin.fit.Field.setValue(): " + subFieldIndex
                        + " is not a valid subfield index of " + this.name + ".");
        }
    ...
    public boolean read(InputStream in, int size) {
        try {
