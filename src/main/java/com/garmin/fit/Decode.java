    ...
    public RETURN read(byte data) {
        ...
        case FILE_HDR:
            ...
            case 1:
                if ((data & Fit.PROTOCOL_VERSION_MAJOR_MASK) > (Fit.PROTOCOL_VERSION_MAJOR << Fit.PROTOCOL_VERSION_MAJOR_SHIFT))
                    throw new FitRuntimeException("FIT decode error: Protocol version "
        ...
        case MESG_NUM_1:
            ...
            if (localMesgDefs[localMesgIndex].arch == Fit.ARCH_ENDIAN_BIG) {
                ...
                throw new FitRuntimeException("FIT decode error: Endian " + localMesgDefs[localMesgIndex].arch
                        + " not supported.");
            }
